...
from aksesa_cli.plugin import PluginError
...
def install_cmd(
    ...
    from aksesa_cli.plugin.manager import get_plugins_dir, install_plugin
    ...
    try:
        ...
        from aksesa_cli.plugin.manager import collect_host_values
...
def list_cmd() -> None:
    ...
    from aksesa_cli.plugin.manager import get_plugins_dir, list_plugins
...
def remove_cmd(
    ...
    from aksesa_cli.plugin.manager import get_plugins_dir, remove_plugin
...
def info_cmd(
    ...
    """Show plugin details."""
    from aksesa_cli.plugin import parse_plugin_json
