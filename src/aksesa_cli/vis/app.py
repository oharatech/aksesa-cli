"""Aksesa Agent Tracing Visualizer application."""
...
from aksesa_cli.utils.server import (
    find_available_port,
    format_url,
...
from aksesa_cli.vis.api import sessions_router, statistics_router, system_router
from aksesa_cli.web.api.open_in import router as open_in_router

STATIC_DIR = Path(__file__).parent / "static"
GZIP_MINIMUM_SIZE = 1024
GZIP_COMPRESSION_LEVEL = 6
DEFAULT_PORT = 5495
_ENV_RESTRICT_OPEN_IN = "AKSESA_VIS_RESTRICT_OPEN_IN"
...
def create_app() -> FastAPI:
    ...
    application = FastAPI(
        title="Aksesa Agent Tracing Visualizer",
        docs_url=None,
...
def run_vis_server(
    ...
    # Build display hosts (same logic as aksesa web)
    ...
    if not public_mode:
        ...
        banner_lines.extend(
            [
                ...
                "<nowrap>  Please report issues to the aksesa-cli team.",
                "",
            ]
        )
