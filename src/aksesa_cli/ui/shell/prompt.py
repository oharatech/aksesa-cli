...
from aksesa_cli.soul import StatusSnapshot, format_context_status
from aksesa_cli.ui.shell import placeholders as prompt_placeholders
from aksesa_cli.ui.shell.console import console
from aksesa_cli.ui.shell.placeholders import (
    PromptPlaceholderManager,
    normalize_pasted_text,
    sanitize_surrogates,
)
from aksesa_cli.ui.theme import get_prompt_style, get_toolbar_colors
from aksesa_cli.utils.clipboard import (
    grab_media_from_clipboard,
    is_clipboard_available,
    is_media_clipboard_available,
)
from aksesa_cli.utils.logging import logger
from aksesa_cli.utils.slashcmd import SlashCommand
from aksesa_cli.wire.types import ContentPart
...
class LocalFileMentionCompleter(Completer):
    ...
    :mod:`aksesa_cli.utils.file_filter` so that the web backend can reuse
    them.
    """
    ...
    def _get_top_level_paths(self) -> list[str]:
        from aksesa_cli.utils.file_filter import is_ignored
    ...
    def _get_deep_paths(self) -> list[str]:
        from aksesa_cli.utils.file_filter import (
            detect_git,
            git_index_mtime,
            list_files_git,
            list_files_walk,
...
class CustomPromptSession:
    ...
    def _open_in_external_editor(self, event: KeyPressEvent) -> None:
        ...
        from aksesa_cli.utils.editor import edit_text_in_editor, get_editor_command
