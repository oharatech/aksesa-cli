...
from aksesa_cli.ui.shell.echo import render_user_echo_text
from aksesa_cli.ui.shell.mcp_status import render_mcp_prompt
from aksesa_cli.ui.shell.prompt import (
    BgTaskCounts,
    CustomPromptSession,
    CwdLostError,
    PromptMode,
...
from aksesa_cli.ui.shell.replay import replay_recent_history
from aksesa_cli.ui.shell.slash import SKILL_COMMAND_PREFIX, shell_mode_registry
from aksesa_cli.ui.shell.slash import registry as shell_slash_registry
from aksesa_cli.ui.shell.update import LATEST_VERSION_FILE, UpdateResult, do_update, semver_tuple
from aksesa_cli.ui.shell.visualize import (
    ApprovalPromptDelegate,
    visualize,
)
from aksesa_cli.utils.aioqueue import QueueShutDown
from aksesa_cli.utils.envvar import get_env_bool
from aksesa_cli.utils.logging import open_original_stderr
from aksesa_cli.utils.signals import install_sigint_handler
from aksesa_cli.utils.slashcmd import SlashCommand, SlashCommandCall, parse_slash_command_call
from aksesa_cli.utils.subprocess_env import get_clean_env
from aksesa_cli.utils.term import ensure_new_line, ensure_tty_sane
...
class Shell:
    ...
    async def run(self, command: str | None = None) -> bool:
        ...
        if isinstance(self.soul, KimiSoul):
            from aksesa_cli.ui.theme import set_active_theme
        ...
        _print_welcome_info(self.soul.name or "Aksesa CLI", self._welcome_info)

        # Start telemetry periodic flush and disk retry
        from aksesa_cli.telemetry import get_sink
        ...
        with CustomPromptSession(
            ...
            try:
                while True:
                    ...
                    from aksesa_cli.ui.shell.visualize import InputAction, classify_input
    ...
    async def _run_slash_command(self, command_call: SlashCommandCall) -> None:
        from aksesa_cli.cli import Reload, SwitchToVis, SwitchToWeb
        from aksesa_cli.telemetry import track
    ...
    async def _run_btw_modal(
        ...
        """
        from aksesa_cli.soul.btw import execute_side_question
        from aksesa_cli.ui.shell.visualize import (
...
def _print_welcome_info(name: str, info_items: list[WelcomeInfoItem]) -> None:
    head = Text.from_markup("Welcome to Aksesa CLI!")
