...
from aksesa_cli.tools.shell import Params as ShellParams
from aksesa_cli.tools.shell import Shell
from aksesa_cli.tools.utils import ToolResultBuilder
from aksesa_cli.wire.types import DisplayBlock
...
class Terminal(CallableTool2[ShellParams]):
    ...
    async def __call__(self, params: ShellParams) -> ToolReturnValue:
        from aksesa_cli.acp.session import get_current_acp_tool_call_id_or_none
