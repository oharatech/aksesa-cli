...
from aksesa_cli.skill.flow import Flow, FlowError
from aksesa_cli.skill.flow.d2 import parse_d2_flowchart
from aksesa_cli.skill.flow.mermaid import parse_mermaid_flowchart
from aksesa_cli.utils.frontmatter import parse_frontmatter
...
def get_builtin_skills_dir() -> Path:
    ...
    if getattr(sys, "frozen", False) and hasattr(sys, "_MEIPASS"):
        ...
        return Path(meipass) / "aksesa_cli" / "skills"
...
def _first_meaningful_line(content: str) -> str | None:
    ...
    :mod:`aksesa_cli.utils.frontmatter`). A malformed frontmatter opener that
    ...
    """
    from aksesa_cli.utils.frontmatter import strip_frontmatter
