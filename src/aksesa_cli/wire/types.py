...
from aksesa_cli.tools.display import (
...
from aksesa_cli.utils.typing import flatten_union
...
class ApprovalRequest(BaseModel):
    ...
    # Note that the above fields are just a copy of `aksesa_cli.soul.approval.Request`, but
