...
from aksesa_cli.approval_runtime import (
    ApprovalSource,
    get_current_approval_source_or_none,
    reset_current_approval_source,
    set_current_approval_source,
)
from aksesa_cli.background import build_active_task_snapshot
from aksesa_cli.hooks.engine import HookEngine
from aksesa_cli.llm import ModelCapability
from aksesa_cli.notifications import (
    NotificationView,
    build_notification_message,
    extract_notification_ids,
)
from aksesa_cli.skill import Skill, read_skill_text
from aksesa_cli.skill.flow import Flow, FlowEdge, FlowNode, parse_choice
...
from aksesa_cli.soul.agent import Agent, Runtime
from aksesa_cli.soul.compaction import (
    CompactionResult,
    SimpleCompaction,
    estimate_text_tokens,
    should_auto_compact,
)
from aksesa_cli.soul.context import Context
from aksesa_cli.soul.dynamic_injection import (
    DynamicInjection,
    DynamicInjectionProvider,
    normalize_history,
)
from aksesa_cli.soul.dynamic_injections.afk_mode import AfkModeInjectionProvider
from aksesa_cli.soul.dynamic_injections.plan_mode import PlanModeInjectionProvider
from aksesa_cli.soul.message import check_message, system, system_reminder, tool_result_to_message
from aksesa_cli.soul.slash import registry as soul_slash_registry
from aksesa_cli.soul.toolset import KimiToolset
from aksesa_cli.tools.dmail import NAME as SendDMail_NAME
from aksesa_cli.tools.utils import ToolRejectedError
from aksesa_cli.utils.logging import logger
from aksesa_cli.utils.slashcmd import SlashCommand, parse_slash_command_call
from aksesa_cli.wire.file import WireFile
...
class KimiSoul:
    ...
    def __init__(
        ...
        *,
        ...
        if self._plan_session_id is not None and self._runtime.session.state.plan_slug is not None:
            from aksesa_cli.tools.plan.heroes import seed_slug_cache
    ...
    def _bind_plan_mode_tools(self) -> None:
        ...
        from aksesa_cli.tools.file.write import WriteFile
        ...
        from aksesa_cli.tools.file.replace import StrReplaceFile
        ...
        from aksesa_cli.tools.plan import ExitPlanMode
        ...
        from aksesa_cli.tools.plan.enter import EnterPlanMode
        ...
        from aksesa_cli.tools.ask_user import AskUserQuestion
    ...
    def _ensure_plan_session_id(self) -> None:
        ...
        if self._plan_session_id is None:
            ...
            from aksesa_cli.tools.plan.heroes import get_or_create_slug
    ...
    def get_plan_file_path(self) -> Path | None:
        ...
        if self._plan_session_id is None:
            return None
        from aksesa_cli.tools.plan.heroes import get_plan_file_path
    ...
    def read_current_plan(self) -> str | None:
        ...
        if self._plan_session_id is None:
            return None
        from aksesa_cli.tools.plan.heroes import read_plan_file
    ...
    async def run(
        ...
        *,
        ...
        try:
            ...
            from aksesa_cli.soul.toolset import set_session_id

            set_session_id(self._runtime.session.id)

            from aksesa_cli.hooks import events
            ...
            wire_send(TurnBegin(user_input=user_input))
            turn_started = True
            from aksesa_cli.telemetry import track as _track_telemetry
            ...
            if not command_call:
                ...
                if session.state.custom_title is None:
                    from aksesa_cli.utils.string import shorten
                    ...
                    if title:
                        from aksesa_cli.session_state import (
                            load_session_state,
                            save_session_state,
                        )
    ...
    def _make_skill_runner(self, skill: Skill) -> Callable[[KimiSoul, str], None | Awaitable[None]]:
        async def _run_skill(soul: KimiSoul, args: str, *, _skill: Skill = skill) -> None:
            from aksesa_cli.telemetry import track
    ...
    async def _agent_loop(self) -> TurnOutcome:
        ...
        if isinstance(self._agent.toolset, KimiToolset):
            ...
            try:
                ...
                if loading:
                    from aksesa_cli.telemetry import track as _track_mcp
        ...
        while True:
            ...
            try:
                ...
                # --- StopFailure hook ---
                from aksesa_cli.hooks import events as _hook_events
