...
import aksesa_cli.prompts as prompts
from aksesa_cli import logger
from aksesa_cli.soul import wire_send
from aksesa_cli.soul.agent import load_agents_md
from aksesa_cli.soul.context import Context
from aksesa_cli.soul.dynamic_injections.afk_mode import AFK_DISABLED_REMINDER
from aksesa_cli.soul.message import system, system_reminder
from aksesa_cli.utils.export import is_sensitive_file
from aksesa_cli.utils.path import sanitize_cli_path, shorten_home
from aksesa_cli.utils.slashcmd import SlashCommandRegistry
from aksesa_cli.wire.types import StatusUpdate, TextPart
...
async def add_dir(soul: KimiSoul, args: str):
    ...
    from aksesa_cli.utils.path import is_within_directory, list_directory
...
async def export(soul: KimiSoul, args: str):
    ...
    from aksesa_cli.utils.export import perform_export
...
async def import_context(soul: KimiSoul, args: str):
    ...
    from aksesa_cli.utils.export import perform_import
