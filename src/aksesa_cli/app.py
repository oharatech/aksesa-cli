...
from aksesa_cli.llm import augment_provider_with_env_vars, create_llm, model_display_name
from aksesa_cli.session import Session
from aksesa_cli.share import get_share_dir
from aksesa_cli.soul import RunCancelled, run_soul
from aksesa_cli.soul.agent import Runtime, load_agent
...
from aksesa_cli.utils.logging import logger, open_original_stderr, redirect_stderr_to_logger
from aksesa_cli.utils.path import shorten_home
from aksesa_cli.wire import Wire, WireUISide
from aksesa_cli.wire.types import ApprovalRequest, ApprovalResponse, ContentPart, WireMessage
...
def _patch_session_id(record: dict[str, Any]) -> None:
    ...
    try:
        from aksesa_cli.soul.toolset import get_session_id
...
async def _refresh_managed_models_silent(config: Config) -> None:
    from aksesa_cli.auth.platforms import refresh_managed_models
...
class KimiCLI:
    ...
    async def create(
        ...
        *,
        ...
        try:
            from aksesa_cli.plugin.manager import (
                collect_host_values,
                get_plugins_dir,
        ...
        if telemetry_disabled:
            ...
            from aksesa_cli.telemetry.sink import EventSink
        ...
        from aksesa_cli.telemetry import track, track_session_started_once
        from aksesa_cli.telemetry.crash import install_asyncio_handler, set_phase
    ...
    async def run_shell(
        ...
        from aksesa_cli.ui.shell import Shell, WelcomeInfoItem
    ...
    async def run_print(
        ...
        *,
        ...
        from aksesa_cli.ui.print import Print
    ...
    async def run_acp(self) -> None:
        ...
        from aksesa_cli.ui.acp import ACP
    ...
    async def run_wire_stdio(self) -> None:
        ...
        from aksesa_cli.wire.server import WireServer
