...
from aksesa_cli.metadata import WorkDirMeta, load_metadata
from aksesa_cli.session import Session as KimiCLISession
from aksesa_cli.session_state import SessionState, load_session_state, save_session_state
from aksesa_cli.web.models import Session
...
class JointSession(Session):
    ...
    aksesa_cli_session: KimiCLISession = Field(exclude=True)
...
def _build_joint_session(entry: SessionIndexEntry) -> JointSession:
    ...
    return JointSession(
        ...
        aksesa_cli_session=kimi_session,
