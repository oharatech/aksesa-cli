...
from aksesa_cli.web.runner.messages import new_session_status_message
from aksesa_cli.web.store.sessions import load_session_by_id
...
class SessionProcess:
    ...
    async def _encode_uploaded_files(self) -> AsyncGenerator[ContentPart]:
        ...
        uploads_dir = session.aksesa_cli_session.dir / "uploads"
