...
Usage:
    python -m aksesa_cli.web.runner.worker <session_id>
"""
...
from aksesa_cli.cli.mcp import get_global_mcp_config_file
from aksesa_cli.exception import MCPConfigError
...
async def run_worker(session_id: UUID) -> None:
    ...
    session = joint_session.aksesa_cli_session
