...
from aksesa_cli.wire.types import ApprovalRequest, ApprovalResponse, QuestionRequest, StatusUpdate
...
async def test_render_agent_status_excludes_panels_in_interactive() -> None:
    ...
    from aksesa_cli.ui.shell.visualize import _PromptLiveView
...
async def test_shell_external_approval_response_syncs_modal(
    ...
    from aksesa_cli.soul.agent import Agent
