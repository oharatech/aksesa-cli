...
from aksesa_cli.ui.shell.console import _OSC8_RE, render_to_ansi
...
@pytest.mark.skipif(os.name == "nt", reason="OSC 8 hyperlinks are terminal-specific")
...
@pytest.mark.skipif(os.name == "nt", reason="Truecolor terminal tests are terminal-specific")
