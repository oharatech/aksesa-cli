...
from aksesa_cli.soul import StatusSnapshot
...
@pytest.mark.skipif(os.name == "nt", reason="Modal prompt tests require a real Windows console")
...
@pytest.mark.skipif(os.name == "nt", reason="Prompt async tests require a real Windows console")
@pytest.mark.asyncio
