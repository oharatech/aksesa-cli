...
from aksesa_cli.ui.shell.prompt import PromptMode, UserInput
from aksesa_cli.wire.types import ApprovalRequest, StatusUpdate, SteerInput, TextPart

shell_visualize = importlib.import_module("aksesa_cli.ui.shell.visualize")
# Sub-modules for monkeypatching internal names (Live, _keyboard_listener, console)
_live_view_mod = importlib.import_module("aksesa_cli.ui.shell.visualize._live_view")
_interactive_mod = importlib.import_module("aksesa_cli.ui.shell.visualize._interactive")
...
def _make_two_question_request():
    ...
    from aksesa_cli.wire.types import QuestionItem, QuestionOption
    from aksesa_cli.wire.types import QuestionRequest as QR
...
def test_approval_feedback_cursor_markup_in_middle():
    ...
    from aksesa_cli.ui.shell.visualize._approval_panel import _render_feedback_with_cursor
