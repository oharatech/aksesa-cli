...
from aksesa_cli.ui.shell import prompt as shell_prompt
from aksesa_cli.ui.shell.prompt import PromptMode
from aksesa_cli.utils.clipboard import ClipboardResult
...
@pytest.mark.skipif(os.name == "nt", reason="Clipboard tests use POSIX paths")
...
async def test_question_delegate_expands_placeholders_on_submit() -> None:
    ...
    from aksesa_cli.ui.shell.visualize import QuestionPromptDelegate, QuestionRequestPanel
    from aksesa_cli.wire.types import QuestionItem, QuestionRequest
