...
from aksesa_cli.ui.shell.placeholders import PromptPlaceholderManager
...
async def test_open_in_external_editor_uses_provider_value(monkeypatch) -> None:
    ...
    monkeypatch.setattr("aksesa_cli.utils.editor.get_editor_command", fake_get_editor_command)
    monkeypatch.setattr("aksesa_cli.utils.editor.edit_text_in_editor", fake_edit_text_in_editor)
...
def test_open_in_external_editor_toast_when_no_editor(monkeypatch) -> None:
    ...
    monkeypatch.setattr("aksesa_cli.utils.editor.get_editor_command", lambda configured=None: None)
