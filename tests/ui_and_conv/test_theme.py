...
from aksesa_cli.config import Config, get_default_config
...
from aksesa_cli.ui.shell import slash as shell_slash
from aksesa_cli.ui.theme import (
    get_active_theme,
    get_diff_colors,
...
def test_theme_command_registered_in_both_registries():
    from aksesa_cli.ui.shell.slash import registry, shell_mode_registry
...
async def test_shell_startup_initializes_theme_from_config(
    ...
    from aksesa_cli.ui import theme as theme_mod
    from aksesa_cli.ui.shell import Shell as RealShell
...
def test_render_diff_panel_both_themes():
    ...
    from aksesa_cli.utils.rich.diff_render import (
        DiffLine,
        DiffLineKind,
        render_diff_panel,
    )
