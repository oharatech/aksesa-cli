...
from aksesa_cli.config import LLMProvider, OAuthRef
...
from aksesa_cli.ui.shell.slash import shell_mode_registry
...
def _setup_submission_mocks(monkeypatch, *, feedback_text="Great tool!", session_factory=None):
    ...
    if session_factory is not None:
        monkeypatch.setattr("aksesa_cli.utils.aiohttp.new_client_session", session_factory)
...
@pytest.mark.skipif(os.name == "nt", reason="Shell UI tests are terminal-specific")
