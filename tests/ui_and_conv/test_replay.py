...
import aksesa_cli.ui.shell.replay as replay_module
from aksesa_cli.soul.message import system_reminder
from aksesa_cli.ui.shell.replay import (
...
from aksesa_cli.wire.types import SteerInput, StepBegin, TextPart, TurnBegin
