...
from aksesa_cli.tools.shell import Params
...
@pytest.mark.skipif(os.name == "nt", reason="Background tools tests rely on POSIX shell behavior")
@pytest.mark.asyncio
...
async def test_task_stop_rejected_by_approval(runtime, task_stop_tool, monkeypatch):
    ...
    from aksesa_cli.soul.approval import ApprovalResult
