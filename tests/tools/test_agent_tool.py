...
from aksesa_cli.approval_runtime import get_current_approval_source_or_none
from aksesa_cli.soul import MaxStepsReached, RunCancelled
from aksesa_cli.soul.agent import Agent as SoulAgent
from aksesa_cli.subagents import AgentLaunchSpec, AgentTypeDefinition, ToolPolicy
from aksesa_cli.wire.types import ApprovalRequest, TextPart
...
async def test_agent_tool_creates_instance_and_returns_agent_id(agent_tool, runtime, monkeypatch):
    ...
    monkeypatch.setattr("aksesa_cli.subagents.builder.load_agent", fake_load_agent)
    monkeypatch.setattr("aksesa_cli.subagents.runner.run_soul", fake_run_soul)
...
async def test_foreground_agent_explicit_timeout_returns_tool_error(
    ...
    monkeypatch.setattr("aksesa_cli.subagents.builder.load_agent", fake_load_agent)
    monkeypatch.setattr("aksesa_cli.subagents.runner.run_soul", fake_run_soul_hang)
...
async def test_foreground_agent_internal_timeout_with_explicit_deadline(
    ...
    monkeypatch.setattr("aksesa_cli.subagents.builder.load_agent", fake_load_agent)
    monkeypatch.setattr("aksesa_cli.subagents.runner.run_soul", fake_run_soul_internal_timeout)
...
async def test_agent_tool_returns_error_when_final_response_is_none(
    ...
    monkeypatch.setattr(
        "aksesa_cli.subagents.runner.run_with_summary_continuation",
...
async def test_background_agent_marks_failed_when_final_response_is_none(
    ...
    monkeypatch.setattr(
        "aksesa_cli.background.agent_runner.run_with_summary_continuation",
        fake_run_with_summary,
    )
...
async def test_foreground_runner_hook_trigger_exception_marks_instance_failed(
    ...
    monkeypatch.setattr(
        "aksesa_cli.hooks.events.subagent_start",
