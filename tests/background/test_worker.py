...
from aksesa_cli.background import (
    BackgroundTaskStore,
    TaskControl,
    TaskSpec,
    run_background_task_worker,
)
from aksesa_cli.background.worker import terminate_process_tree_windows
...
def test_terminate_process_tree_windows_uses_taskkill_tree(monkeypatch):
    ...
    monkeypatch.setattr("aksesa_cli.background.worker.subprocess.run", _run)
