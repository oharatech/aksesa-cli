...
from aksesa_cli.ui.shell.usage import UsageRow, _format_row, _ratio_color, _remaining_quota, _to_int
...
@pytest.mark.skipif(os.name == "nt", reason="Rich bar rendering differs on Windows console")
