...
class TestAPIErrorClassification:
    ...
    def test_429_maps_to_rate_limit(self):
        from aksesa_cli.soul.kimisoul import classify_api_error
...
class TestEventPropertyCorrectness:
    ...
    def test_background_task_no_event_without_start_time(self):
        ...
        from aksesa_cli.background.manager import BackgroundTaskManager
        from aksesa_cli.background.models import TaskRuntime
        ...
        with patch("aksesa_cli.telemetry.track") as mock_track:
...
class TestSessionStarted:
    ...
    def test_track_session_started_wire_uses_current_client_info(self):
        from aksesa_cli.telemetry import set_client_info, track_session_started_once
...
class TestCompactionTracking:
    ...
    async def test_auto_compaction_success_emits_event(self):
        ...
        with (
            patch("aksesa_cli.soul.kimisoul.wire_send"),
            patch("aksesa_cli.telemetry.track") as mock_track,
        ):
