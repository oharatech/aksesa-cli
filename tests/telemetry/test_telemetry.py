...
import aksesa_cli.telemetry as telemetry_mod
from aksesa_cli.telemetry import attach_sink, disable, set_context, track
...
class TestAsyncTransport:
    def test_save_to_disk(self, tmp_path: Path):
        ...
        with patch("aksesa_cli.telemetry.transport._telemetry_dir", return_value=tmp_path):
    ...
    async def test_send_falls_back_on_error(self):
        ...
        from aksesa_cli.telemetry.transport import _TransientError
    ...
    def test_default_retry_schedule(self):
        ...
        from aksesa_cli.telemetry.transport import RETRY_BACKOFFS_S
    ...
    def test_server_prefix_constant(self):
        ...
        from aksesa_cli.telemetry.transport import SERVER_EVENT_PREFIX
    ...
    def test_apply_server_prefix_one_does_not_mutate_input(self):
        ...
        from aksesa_cli.telemetry.transport import _apply_server_prefix_one
    ...
    async def test_retry_disk_events_success(self, tmp_path: Path):
        ...
        with (
            patch("aksesa_cli.telemetry.transport._telemetry_dir", return_value=tmp_path),
    ...
    async def test_send_401_no_token_drops(self, tmp_path: Path):
        ...
        with (
            patch("aksesa_cli.telemetry.transport._telemetry_dir", return_value=tmp_path),
            patch("aksesa_cli.utils.aiohttp.new_client_session", return_value=mock_session),
        ):
            await transport.send([{"event": "test", "timestamp": 1.0}])
...
class TestPayloadAssembly:
    ...
    def test_user_id_prefix_constant(self):
        ...
        from aksesa_cli.telemetry.transport import USER_ID_PREFIX

        assert USER_ID_PREFIX == "kfc_device_id_"

    def test_build_user_id(self):
        from aksesa_cli.telemetry.transport import _build_user_id
    ...
    def test_flatten_event_properties_prefix(self):
        from aksesa_cli.telemetry.transport import _flatten_event
    ...
    def test_build_payload_user_id_at_top(self):
        from aksesa_cli.telemetry.transport import _build_payload
