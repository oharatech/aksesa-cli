...
from aksesa_cli.utils.diff import (
    _HUGE_FILE_THRESHOLD,
    _build_diff_blocks_sync,
    build_diff_blocks,
)
from aksesa_cli.wire.types import DiffDisplayBlock
...
async def test_build_diff_blocks_delegates_to_thread() -> None:
    ...
    with patch("aksesa_cli.utils.diff.asyncio") as mock_asyncio:
...
def test_summary_panel_renders_modification() -> None:
    ...
    from aksesa_cli.utils.rich.diff_render import render_diff_summary_panel
...
def test_summary_panel_renders_new_file() -> None:
    ...
    from aksesa_cli.utils.rich.diff_render import _summary_description
...
def test_summary_preview_returns_renderables() -> None:
    ...
    from aksesa_cli.utils.rich.diff_render import render_diff_summary_preview
