"""Tests for aksesa_cli.utils.rich.diff_render — unified diff rendering."""
...
from aksesa_cli.tools.display import DiffDisplayBlock
from aksesa_cli.utils.diff import _build_diff_blocks_sync as build_diff_blocks
...
class TestHighlightHunk:
    ...
    def test_inline_diff_with_tabs(self) -> None:
        ...
        from aksesa_cli.utils.rich.diff_render import get_diff_colors
