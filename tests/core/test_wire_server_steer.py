...
from aksesa_cli.approval_runtime import ApprovalSource
...
from aksesa_cli.telemetry import set_context
...
from aksesa_cli.wire.types import ApprovalRequest, ApprovalResponse, TextPart
...
async def test_handle_prompt_cleanup_keeps_background_approval_pending(
    ...
    monkeypatch.setattr("aksesa_cli.wire.server.run_soul", fake_run_soul)
