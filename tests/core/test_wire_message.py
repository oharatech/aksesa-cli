...
from aksesa_cli.wire.file import WireMessageRecord
from aksesa_cli.wire.serde import deserialize_wire_message, serialize_wire_message
...
def test_wire_message_type_alias():
    import aksesa_cli.wire.types

    module = aksesa_cli.wire.types
    # Helper types that are BaseModel subclasses but not WireMessage types
    from aksesa_cli.wire.types import HookResponse
...
def test_read_wire_lines_request_id(tmp_path: Path):
    ...
    from aksesa_cli.web.api.sessions import _read_wire_lines
