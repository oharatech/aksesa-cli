...
async def test_skill_discovery_includes_plugins_dir(tmp_path: Path, monkeypatch):
    ...
    from aksesa_cli.skill import resolve_skills_roots
    ...
    # Point AKSESA_SHARE_DIR to tmp_path so get_plugins_dir() returns tmp_path/plugins
