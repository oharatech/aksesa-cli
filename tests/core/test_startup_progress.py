...
import aksesa_cli.ui.shell.startup as startup_module
...
@pytest.mark.asyncio
async def test_aksesa_cli_create_reports_startup_phases(session, config, monkeypatch) -> None:
    phases: list[str] = []
...
@pytest.mark.asyncio
async def test_aksesa_cli_create_cleans_stale_running_foreground_subagents(
