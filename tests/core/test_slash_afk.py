...
from aksesa_cli.soul.dynamic_injection import DynamicInjection, DynamicInjectionProvider
from aksesa_cli.soul.kimisoul import KimiSoul
from aksesa_cli.soul.slash import afk as afk_slash
from aksesa_cli.soul.slash import yolo as yolo_slash
...
async def test_afk_slash_toggles_afk_flag(
    ...
    sent: list[TextPart] = []
    monkeypatch.setattr("aksesa_cli.soul.slash.wire_send", lambda msg: sent.append(msg))
...
async def test_afk_slash_notifies_injection_providers(
    ...
    monkeypatch.setattr("aksesa_cli.soul.slash.wire_send", lambda _msg: None)
