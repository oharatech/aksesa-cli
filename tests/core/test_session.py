...
from aksesa_cli.wire.file import WireFileMetadata, WireMessageRecord
from aksesa_cli.wire.protocol import WIRE_PROTOCOL_VERSION
from aksesa_cli.wire.types import TextPart, TurnBegin
...
def isolated_share_dir(monkeypatch, tmp_path: Path) -> Path:
    ...
    monkeypatch.setattr("aksesa_cli.share.get_share_dir", _get_share_dir)
    monkeypatch.setattr("aksesa_cli.metadata.get_share_dir", _get_share_dir)
    return share_dir
...
async def test_custom_title_overrides_wire_title(isolated_share_dir: Path, work_dir: KaosPath):
    ...
    from aksesa_cli.session_state import save_session_state
...
async def test_save_state_preserves_in_memory_todos(isolated_share_dir: Path, work_dir: KaosPath):
    ...
    from aksesa_cli.session_state import TodoItemState, load_session_state
