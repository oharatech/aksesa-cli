...
from aksesa_cli.agentspec import DEFAULT_AGENT_FILE, load_agent_spec
from aksesa_cli.exception import AgentSpecError
...
def test_load_default_agent_spec():
    ...
    assert spec.tools == snapshot(
        [
            "aksesa_cli.tools.agent:Agent",
            "aksesa_cli.tools.ask_user:AskUserQuestion",
            "aksesa_cli.tools.todo:SetTodoList",
            "aksesa_cli.tools.shell:Shell",
            "aksesa_cli.tools.background:TaskList",
            "aksesa_cli.tools.background:TaskOutput",
            "aksesa_cli.tools.background:TaskStop",
            "aksesa_cli.tools.file:ReadFile",
            "aksesa_cli.tools.file:ReadMediaFile",
            "aksesa_cli.tools.file:Glob",
            "aksesa_cli.tools.file:Grep",
            "aksesa_cli.tools.file:WriteFile",
            "aksesa_cli.tools.file:StrReplaceFile",
            "aksesa_cli.tools.web:SearchWeb",
            "aksesa_cli.tools.web:FetchURL",
            "aksesa_cli.tools.plan:ExitPlanMode",
            "aksesa_cli.tools.plan.enter:EnterPlanMode",
        ]
    )
    subagents = {
...
def test_load_agent_spec_basic(agent_file: Path):
    ...
    assert spec.tools == snapshot(["aksesa_cli.tools.think:Think"])
...
def test_load_agent_spec_with_exclude_tools(agent_file_with_tools: Path):
    ...
    assert spec.tools == snapshot(["aksesa_cli.tools.think:Think", "aksesa_cli.tools.shell:Shell"])
    assert spec.exclude_tools == snapshot(["aksesa_cli.tools.shell:Shell"])
...
""")
        ...
        assert spec.exclude_tools == snapshot(
            ["aksesa_cli.tools.web:SearchWeb", "aksesa_cli.tools.web:FetchURL"]
        )
...
agent:
  ...
  tools: ["aksesa_cli.tools.think:Think"]
""")
...
agent:
  name: "Test Agent"
  system_prompt_path: ./system.md
  tools: ["aksesa_cli.tools.think:Think", "aksesa_cli.tools.shell:Shell"]
  exclude_tools: ["aksesa_cli.tools.shell:Shell"]
""")
