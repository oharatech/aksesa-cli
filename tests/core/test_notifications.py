...
from aksesa_cli.approval_runtime import ApprovalSource, get_current_approval_source_or_none
from aksesa_cli.background import TaskRuntime, TaskSpec
from aksesa_cli.llm import LLM
from aksesa_cli.notifications import NotificationEvent
from aksesa_cli.soul import RunCancelled, StatusSnapshot, _current_wire, run_soul
...
from aksesa_cli.wire.types import ApprovalRequest, ApprovalResponse, Notification
...
@pytest.mark.asyncio
async def test_aksesa_cli_run_yields_root_hub_approvals(runtime: Runtime) -> None:
...
@pytest.mark.asyncio
async def test_aksesa_cli_run_bridges_approval_resolution_back_to_runtime(runtime: Runtime) -> None:
...
@pytest.mark.asyncio
async def test_aksesa_cli_run_cancels_abandoned_approval_stream(
    runtime: Runtime,
    tmp_path: Path,
...
@pytest.mark.asyncio
async def test_aksesa_cli_run_propagates_external_cancel_event(
    runtime: Runtime,
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
