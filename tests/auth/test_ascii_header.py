...
from aksesa_cli.auth.oauth import _ascii_header_value, _common_headers
...
class TestCommonHeaders:
    ...
    @patch("aksesa_cli.auth.oauth.platform")
    @patch("aksesa_cli.auth.oauth.get_device_id", return_value="abc123")
